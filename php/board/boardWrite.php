            ...
            <article class="content-article">
                ...
                <section class="section-board">
                    ...
                    <div class="board-write"> 
                        <form action="boardWriteSave.php" name="reqform" method="post" enctype="multipart/form-data"> 
                            <!--enctype="multipart/form-data" 꼭 써줘야함 파일 업로드는 Post -->
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <input type="file" value="1" name="imgFile" id="imgFile">
                                </div> <!--name="imgFile" 꼭 써줘야함!-->
                            </fieldset>
